                    ...
                    <div class="card-body">
                        <form:form action="register_user" method="post" modelAttribute="user">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <form:input type="text" id="email_address" class="form-control" name="email"  path="email"/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <form:input type="text" id="user_name" class="form-control" name="name"  path="name"/>
                            </div>
                    </div>
                            ...
                            <div class="col-md-6 offset-md-4">
                                ...
                                <c:if test="${failedReg != null}">
                                    <b><p style="color: brown" class="my-3">Passwords don't match, try again</p></b>
                                </c:if>
                    </div>
                </div>
            </div>
